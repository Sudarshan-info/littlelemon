...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-r-%0eqcja86asp_+*1@3d6t9wm65$7^p*v^m961p@)w7*3ob0n')
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'restaurant' / 'templates'],  # absolute path
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://littlelemon_user:littlelemon@localhost:5432/littlelemon_db'
    )
}
